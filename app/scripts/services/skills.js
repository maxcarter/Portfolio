    ...
    .factory('Skills', function() {
        return {
            ...
            panels: [{
                ...
                "icon": "fa-code",
                "description": "Web development is my specialty. I have several years of experience designing, developing, and maintaining websites for various companies. I first learnt the basics of web development in a high school computer science class and have since been self learning the latest and greatest of web technologies on my own time. I have had various co-op employments that emphasized web development with cloud computing. I have since learnt how to create full scale single page web applications, and complete RESTful APIs. I have built Dashboards, Consoles, Admin tools, and even a completely automated PaaS. My focus now lies in the development responsive and easy to use web applications that are supported by fully automated backends and RESTful APIs."
            }, {
                "title": "Front-End Development",
                "body": "HTML, CSS, JavaScript, jQuery, AngularJS, BootStrap, Yeoman, GruntJS, Bower",
                "icon": "fa-code",
                "description": "I thrive to develop professional, response front-ends with special emphasis on UI and UX. My websites and web apps scale to work on various screen sizes on any device that has an internet browser. I have designed and built various websites and have had three university work terms developing data-driven web applications. My specialty lies in using JavaScript frameworks to effectively complement responsive HTML and CSS web user interfaces. Browse some of my projects below to view some of the web applications I tinkered together on my spare time."
            }, {
